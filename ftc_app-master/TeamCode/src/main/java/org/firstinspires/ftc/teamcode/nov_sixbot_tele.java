...
@TeleOp(name="nov_six_bot", group="Teleop")
//@Disabled
public class nov_sixbot_tele extends OpMode
{
    double pos = 0.0;
    double pitch = 0.0;
    ...
    private void newreleaseState (nov_sixbot_tele.release_state newreleasestate){
