...
/**SamplingOrderDetector
 * Created by Victo on 9/10/2018.
 */

public class SamplingOrderDetector extends DogeCVDetector implements UVCCamera.Callback{
    ...
    public SamplingOrderDetector() {
        super(); //this will probably break very many things
    ...
    public Bitmap onFrame(Bitmap bm){
        ...
        if(save) {
            ...
            save = false;
            return PSVisionUtils.matToBitmap(hsv);
        }
