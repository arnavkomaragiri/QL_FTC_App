 ...
 */
@Autonomous(name = "State: QL_Auto_R1_X",group = "State:")
public class QL_Auto_R1_X extends OpMode{
        ...
        switch (mRobotState){
            ...
            case STATE_COLORSCAN:
                ...
                if (mStateTime.time() >= 0.25){
                    ...
                    if (mStateTime.time() >= 1.5 && !bFoundColor){
    ...
    private void newState (QL_Auto_R1_X.State newState){
