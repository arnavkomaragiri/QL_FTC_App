...
public class odo_test extends OpMode {
    ...
    public void loop(){
        ...
        telemetry.addData("X Distance: ", drive.getDrive().getPositioner().compute_rot_x_deg());
        telemetry.addData("Y Distance: ", drive.getDrive().getPositioner().compute_rot_y_deg());
