...
import org.firstinspires.ftc.teamcode.movement.Tracker_Mecanum_Drive;
import org.firstinspires.ftc.teamcode.control.TuningUtil;
...
public class DriveFFTuningOpMode extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        Runner_Mecanum_Drive drive = new Runner_Mecanum_Drive();
        ...
        while (!isStopRequested()) {
            ...
            //if (positionSamples.contains(drive.getEstimatedPose().getY())) {
                timeSamples.add(elapsedTime);
                powerSamples.add(power);
                telemetry.addData("Pos: ", drive.getEstimatedPose().getY());
                positionSamples.add(drive.getEstimatedPose().getY());
            //}
